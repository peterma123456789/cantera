...
export CANTERA_DIR=/Users/wuhao/Codes/Cantera_Chemistry/Cantera/2.4
...
#     boost_inc_dir=$BOOST_DIR  sundials_include=$SUN_INCLUDE sundials_libdir=$SUN_LIB \
#     matlab_path=/Applications/MATLAB_R2014b.app/ \
#     f90_interface=n system_eigen=y extra_inc_dirs=$EIGEN_INCLUDE \
#     debug='yes' debug_flags='-fsanitize=address -fno-omit-frame-pointer' debug_linker_flags='-fsanitize=address'
