...
//    m_active[0] = 0; // Peter modified
//    m_active[1] = 0; // Peter modified
//    m_active[2] = 0; // Peter modified
//    for (int i = 11; i <= 11; i++) m_active[i] = 0;
        ...
        if (m_active[i]) {
            ...
            if ((vmax - vmin) > m_min_range*aa) {
                ...
                for (size_t j = 0; j < n-1; j++) {
                    ...
                    if (r > 1.0 && dz[j] >= 2 * m_gridmin && m_loc.size() == 0) {
                        m_loc[j] = 1;
                        m_c[name] = 1;
                    }
                    if (r >= m_prune) {
            ...
            if ((smax - smin) > m_min_range*ss) {
                ...
                for (size_t j = 0; j < n-2; j++) {
                    ...
                    if (r > 1.0 && dz[j] >= 2 * m_gridmin &&
                            dz[j+1] >= 2 * m_gridmin && m_loc.size() == 0) {
                        m_c[name] = 1;
                        m_loc[j] = 1;
                        m_loc[j+1] = 1;
                    }
