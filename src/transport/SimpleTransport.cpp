...
SimpleTransport::SimpleTransport(thermo_t* thermo, int ndim) : Transport(thermo, ndim),
                                                               tempDepType_(0),
...
SimpleTransport::SimpleTransport(const SimpleTransport& right) : tempDepType_(0),
                                                                 compositionDepType_(LTI_MODEL_SOLVENT),
                                                                 useHydroRadius_(false),
                                                                 doMigration_(0),
                                                                 m_iStateMF(-1),
