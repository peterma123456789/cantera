...
TransportFactory::TransportFactory()
{
    ...
    m_models["Trans_LP"] = cTrans_LP;
    m_models["Trans_HP"] = cTrans_HP;
                                          ...
                                          thermo_t* phase, int log_level, int ndim)
{
    ...
    case cHighP:
        ...
        break;
    case cTrans_LP:
        tr = new TranscriticalTransport;
        tr->init(phase, LP_Mode, log_level);
        break;
    case cTrans_HP:
        tr = new TranscriticalTransport;
        tr->init(phase, HP_Mode, log_level);
        break;
    case cBlend:
        tr = new BlendTransport;
        tr->init(phase, 0, log_level);
        break;
