...
PengRobinsonGasPhase::PengRobinsonGasPhase(const PengRobinsonGasPhase& right)
    : m_p0(right.m_p0)
{
    /*
...
PengRobinsonGasPhase& PengRobinsonGasPhase::operator=(
    const PengRobinsonGasPhase& right)
{
    if (&right != this) {
