...
IdealGasPhase::IdealGasPhase() : m_p0(-1.0),
                                 m_logc0(0.0)
{
}

IdealGasPhase::IdealGasPhase(const std::string& inputFile, const std::string& id_) : m_p0(-1.0),
                                                                                     m_logc0(0.0)
{
  initThermoFile(inputFile, id_);
}

IdealGasPhase::IdealGasPhase(XML_Node& phaseRef, const std::string& id_) : m_p0(-1.0),
                                                                           m_logc0(0.0)
{
  initThermoXML(phaseRef, id_);
}

IdealGasPhase::IdealGasPhase(const IdealGasPhase& right) : m_p0(right.m_p0),
