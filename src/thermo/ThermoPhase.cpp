...
ThermoPhase::ThermoPhase() : m_spthermo(new GeneralSpeciesThermo()), m_speciesData(0),
                             m_phi(0.0),
...
ThermoPhase::ThermoPhase(const ThermoPhase& right) : m_spthermo(new GeneralSpeciesThermo()),
                                                     m_speciesData(0),
                                                     m_phi(0.0),
                                                     m_hasElementPotentials(false),
                                                     m_chargeNeutralityNecessary(false),
