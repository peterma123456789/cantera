...
const int LP_Mode = 20; // Peter added
const int HP_Mode = 30; // Peter added
...
const int cTrans_LP            = 250; // Peter added
const int cTrans_HP            = 255; // Peter added
const int cBlend               = 260; // Peter added
