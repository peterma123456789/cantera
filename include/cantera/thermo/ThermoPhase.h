...
class ThermoPhase : public Phase
{
  ...
  public:
    ...
    {
        throw NotImplementedError("ThermoPhase::setFactor");
    }

    virtual doublereal getFactor()
    {
        throw NotImplementedError("ThermoPhase::getFactor");
    }
  ...
  public:
    ...
    // Peter modified to let transport object get access to critical properties
    ...
    {
        throw NotImplementedError("ThermoPhase::getCritTemperature");
    }
    ...
    {
        throw NotImplementedError("ThermoPhase::getCritPressure");
    }
    ...
    {
        throw NotImplementedError("ThermoPhase::getCritVolume");
    }
    ...
    {
        throw NotImplementedError("ThermoPhase::getCritCompressibility");
    }
    ...
    {
        throw NotImplementedError("ThermoPhase::getAcentricFactor");
    }

    /// Dipole moment (Debye)
    virtual void getDipoleMoment(doublereal* const di) const
    {
        throw NotImplementedError("ThermoPhase::getDipoleMoment");
    }
