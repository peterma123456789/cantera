...
class NasaPoly2 : public SpeciesThermoInterpType
{
  public:
    ...
    NasaPoly2(size_t n, doublereal tlow, doublereal thigh, doublereal pref,
              const doublereal* coeffs) : SpeciesThermoInterpType(n, tlow, thigh, pref),
                                          m_midT(coeffs[0]),
    ...
    NasaPoly2(doublereal tlow, doublereal thigh, doublereal pref,
              const doublereal* coeffs) : SpeciesThermoInterpType(tlow, thigh, pref),
                                          m_midT(coeffs[0]),
     ...
     */
    NasaPoly2(const NasaPoly2& b) : SpeciesThermoInterpType(b),
                                    m_midT(b.m_midT),
                                    mnp_low(b.mnp_low),
                                    mnp_high(b.mnp_high),
                                    m_coeff(b.m_coeff)
