...
class PengRobinsonGasPhase: public ThermoPhase
{
  ...
  public:
     ...
     *                  empty string.
     */
    PengRobinsonGasPhase(const std::string& inputFile, const std::string& id = "");
     ...
     */
    PengRobinsonGasPhase(const PengRobinsonGasPhase& right);
     ...
     * @param right Object to be copied.
     */
    PengRobinsonGasPhase& operator=(const PengRobinsonGasPhase& right);
    ...
    /*!
     *  Returns the value cPengRobinson, defined in mix_defs.h.
     */
    virtual int eosType() const
    {
        return cPengRobinsonGas;
    }
