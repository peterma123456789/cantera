...
#ifndef CT_BLENDGASPHASE_H
#define CT_BLENDGASPHASE_H
 ...
 *
 */
class BlendGasPhase: public ThermoPhase
{
  ...
  public:
    ...
    //! Construct and initialize an BlendGasPhase ThermoPhase object
     ...
     *                  empty string.
     */
    BlendGasPhase(const std::string& inputFile, const std::string& id = "");
     ...
     */
    BlendGasPhase(XML_Node& phaseRef, const std::string& id = "");
     ...
     */
    BlendGasPhase(const BlendGasPhase& right);
     ...
     * @param right Object to be copied.
     */
    BlendGasPhase& operator=(const BlendGasPhase& right);
    ...
    /*!
     *  Returns the value cBlendGas, defined in mix_defs.h.
     */
    ...
    // since the transport class just need critical property of each individual species
    ...
    /// set blending factor
    virtual void setFactor(doublereal f)
    {
        m_bFactor = f;
    }

    virtual doublereal getFactor()
    {
        return m_bFactor;
    }
  ...
  protected:
    ...
    /// blending factor, default value is 1.0 => PR
    doublereal m_bFactor;

    /// ideal gas density [kg/m3]
    doublereal m_density_I;
